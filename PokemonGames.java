...
abstract class AbstractMonster {
    ...
    class GameManager {
        ...
        // Implementasi untuk memulai permainan
        public void startGame() {
            loadGame(); // Memuat progress game dari file
            showMenu();
        }
        ...
        public void battle() {
            ...
            while (playerMonster.getHp() > 0 && enemyMonster.getHp() > 0) {
                if (playerTurn) {
                    ...
                    Random random = new Random();
                    int choice = random.nextInt(3) + 1; // Memilih aksi secara acak (1-3)
                    ...
                    switch (choice) {
                        ...
                        case 3:
                            ...
                            try {
                                ...
                                fileWriter.write("Data progress game...");
                                fileWriter.close();
